...
#define VL11_SPI_START(cfg)        do { (void)(cfg); spiBegin(); spiBeginTransaction(8); } while(0)
#endif
#ifndef VL11_SPI_SEND
#define VL11_SPI_SEND(n, buf)      do { (void)spiExchange((n), (const uint8_t*)(buf), NULL); } while(0)
#endif
#ifndef VL11_SPI_RECV
#define VL11_SPI_RECV(n, buf)      do { (void)spiExchange((n), NULL, (uint8_t*)(buf)); } while(0)
#endif
#ifndef VL11_SPI_SEND_WRITE
#define VL11_SPI_SEND_WRITE(n, buf)      do { (void)spiExchange((n), (const uint8_t*)(buf), NULL); } while(0)
#endif
#ifndef VL11_SPI_RECV_WRITE
#define VL11_SPI_RECV_WRITE(n, buf)      do { (void)spiExchange((n), NULL, (uint8_t*)(buf)); } while(0)
#endif
#ifndef VL11_SPI_SEND_READ
#define VL11_SPI_SEND_READ(n, buf)      do { (void)spiExchange((n), (const uint8_t*)(buf), NULL); } while(0)
#endif
#ifndef VL11_SPI_RECV_READ
#define VL11_SPI_RECV_READ(n, buf)      do { (void)spiExchange((n), NULL, (uint8_t*)(buf)); } while(0)
#endif
